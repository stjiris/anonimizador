...
export const EntityTypeIDefaults: { [key: string]: EntityTypeI } = {
    PES: {
        ...
        subtypes: [
            { name: "Autor", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Réu", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Lesado", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Vítima", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Ofendido", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Demandante", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Assistente", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Arguido", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Exequente", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Executado", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Insolvente", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Testemunha", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE },
            { name: "Ré", color: "#00E2FF", functionIndex: AUTO_ANONIMIZE }
        ]
    },
