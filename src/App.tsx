	...
	render(): React.ReactNode {
		return <div className="App">
			...
			{this.state.userFile == null ? 
				...
				<Anonimize key="anonimize" setUserFile={this.setUserFile} file={this.state.userFile} filters={this.state.filters} saveSateCallback={this.props.saveSateCallback} undoRedoCallback={this.props.undoRedoCallback} stateIndex={this.props.stateIndex} maxStateIndex={this.props.maxStateIndex} listSize={this.props.listSize} offsetIndex={this.props.offsetIndex} />}
