...
EXCLUDE = [
    'Arguido', 'Arguida', 'Arguidos', 'Arguidas', 'Reu', 'Ré', 'Reus', 'Autor', 'Autora', 'Autores', 'Autoras',
    'Tribunal', 'Juízo', 'Vara', 'Instância', 'STJ', 'Supremo Tribunal de Justiça', 'Supremo', 'Tribunal da Relação',
    'Relação', 'Secção do Supremo Tribunal de Justiça', 'artº', 'Exº', 'Exª', 'A.A.', 'nºs', 'Recorrente', 'Requerida',
    'Juiz', 'Juíza', 'Magistrado', 'Magistrada', 'Desembargador', 'Desembargadora', 'Conselheiro', 'Conselheira',
    'Relator', 'Relatora', 'Procurador', 'Procuradora'
]
