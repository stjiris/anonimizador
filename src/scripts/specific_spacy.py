...
EXCLUDE = [
    'Tribunal', 'Juízo', 'Secção', 'Vara', 'Arguído', 'Arguída', 'Arguídos', 'Arguídas', 'Réu', 'Reu', 'Ré', 'Rés',
    'Autores', 'Supremo Tribunal de Justiça', 'STJ', 'Supremo Tribunal', 'Requerida', 'Autora', 'Instância', 'Relação',
    'Supremo', 'Recorrente', 'Recorrida', 'Recorrido', 'Tribunal da Relação', 'artº', 'Exª', 'Exº',
    'Secção do Supremo Tribunal de Justiça', 'A.A.', 'nºs'
]

# Termos referentes a cargos desempenhados por agentes do poder judicial que não devem
# ser anonimizados.
MAGIS_JUIZES_PROC_LIST = [
    'Juiz', 'Juíza', 'Procurador', 'Procuradora', 'Magistrado', 'Magistrada', 'Desembargador', 'Desembargadora',
    'Relator', 'Relatora', 'Conselheiro', 'Conselheira'
]
...
MORADAS_TYPES = [
    "Rua", "Avenida", "Praça", "Largo", "Travessa", "Praceta", "Estrada", "Calçada", "Alameda", "Rotunda",
    "Urbanização", "Beco", "Viela", "Condomínio", "Quinta"
]
